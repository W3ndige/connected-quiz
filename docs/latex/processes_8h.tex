...
void \mbox{\hyperlink{processes_8h_a6af1d9874291402facea43a3c8ac0ef3}{handle\+Child\+Process}} (int socket\+\_\+fd, socklen\+\_\+t socket\+\_\+size, struct sockaddr\+\_\+in destination, int num\+\_\+of\+\_\+categories, int $\ast$pipefd\+\_\+to\+\_\+child, int $\ast$pipefd\+\_\+to\+\_\+parent, struct \mbox{\hyperlink{structquestion__info}{question\+\_\+info}} $\ast$questions, int total\+\_\+number\+\_\+of\+\_\+questions)
...
\mbox{\Hypertarget{processes_8h_a6af1d9874291402facea43a3c8ac0ef3}\label{processes_8h_a6af1d9874291402facea43a3c8ac0ef3}} 
...
{\footnotesize\ttfamily void handle\+Child\+Process (\begin{DoxyParamCaption}\item[{int}]{socket\+\_\+fd,  }\item[{socklen\+\_\+t}]{socket\+\_\+size,  }\item[{struct sockaddr\+\_\+in}]{destination,  }\item[{int}]{num\+\_\+of\+\_\+categories,  }\item[{int $\ast$}]{pipefd\+\_\+to\+\_\+child,  }\item[{int $\ast$}]{pipefd\+\_\+to\+\_\+parent,  }\item[{struct \mbox{\hyperlink{structquestion__info}{question\+\_\+info}} $\ast$}]{questions,  }\item[{int}]{total\+\_\+number\+\_\+of\+\_\+questions }\end{DoxyParamCaption})}
...
\mbox{\tt in}  & {\em int} & socket\+\_\+fd\+: file descriptor for the open socket. \\
\hline
\mbox{\tt in}  & {\em int} & socket\+\_\+size\+: size of the socket. \\
\hline
\mbox{\tt in}  & {\em struct} & sockaddr\+\_\+in destination\+: structure that contains information about client. \\
\hline
\mbox{\tt in}  & {\em struct} & \mbox{\hyperlink{structquestion__info}{question\+\_\+info}} num\+\_\+of\+\_\+categories\+: number of categories. \\
\hline
\mbox{\tt in}  & {\em int} & pipefd\+: array containing pipe file descriptors. \\
\hline
\end{DoxyParams}
...
\mbox{\tt in}  & {\em int} & socket\+\_\+size\+: size of the socket. \\
\hline
\mbox{\tt in}  & {\em struct} & \mbox{\hyperlink{structuser__score}{user\+\_\+score}} destination\+: structure that contains information about client. \\
\hline
\mbox{\tt in}  & {\em int} & num\+\_\+of\+\_\+categories\+: number of categories. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em struct} & \mbox{\hyperlink{structuser__score}{user\+\_\+score}} score\+\_\+table\+: array of \mbox{\hyperlink{structuser__score}{user\+\_\+score}} structures containing pid of user and score. \\
\hline
\mbox{\tt in}  & {\em int} & pipefd\+: array containing pipe file descriptors. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em int} & $\ast$pipefd\+\_\+to\+\_\+child\+: array of \mbox{\hyperlink{structuser__score}{user\+\_\+score}} structures containing pid of user and score. \\
\hline
\mbox{\tt in}  & {\em int} & $\ast$pipefd\+\_\+to\+\_\+parent\+: P\+ID of the client that score is about to be placed. \\
\hline
\mbox{\tt out}  & {\em char} & $\ast$message\+: number of points to be put. \\
\hline
\mbox{\tt in}  & {\em int} & message\+\_\+size Size of the message. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt out}  & {\em struct} & \mbox{\hyperlink{structuser__score}{user\+\_\+score}} score\+\_\+table\+: array of \mbox{\hyperlink{structuser__score}{user\+\_\+score}} structures containing pid of user and score. \\
\hline
\end{DoxyParams}
...
\mbox{\tt in}  & {\em int} & $\ast$pipefd\+\_\+to\+\_\+parent\+: P\+ID of the client that score is about to be placed. \\
\hline
\mbox{\tt in}  & {\em char} & $\ast$message\+: number of points to be put. \\
\hline
\end{DoxyParams}
...
\mbox{\tt out}  & {\em struct} & \mbox{\hyperlink{structuser__score}{user\+\_\+score}} score\+\_\+table\+: array of \mbox{\hyperlink{structuser__score}{user\+\_\+score}} structures containing pid of user and score. \\
\hline
\mbox{\tt in}  & {\em int} & client\+\_\+pid\+: P\+ID of the client that score is about to be placed. \\
\hline
\mbox{\tt in}  & {\em int} & points\+: number of points to be put. \\
\hline
\end{DoxyParams}
